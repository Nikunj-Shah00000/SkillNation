...
const dict = {
  en: {
    ...
    botName: "Stacky",
    botStatus: "Online · multilingual",
    askAssistant: "Ask Stacky",
    openChat: "Open assistant", closeChat: "Close",
    chatPlaceholder: "Ask anything about Skill Stack…",
    botGreeting: "Hi! I'm Stacky, your portal guide. Ask me about courses, jobs, quests, certificates, anything!",
    botFallback: "I didn't quite catch that. Try asking about courses, quests, jobs, the marketplace, certificates, or the Innovation Lab.",
    qaCourses: "Browse courses", qaDuel: "Start a duel", qaJobs: "Find jobs", qaInnov: "Explore Innovation Lab",
    botCoursesReply: "You've got 47 active courses across programming, design, data and AI — each one earns you XP and badges.",
    botGoCourses: "Open My Courses",
    botQuestsReply: "Daily quests double your XP. Streaks unlock rare cosmetics in the marketplace.",
    botGoQuests: "Open Quests",
    botDuelReply: "The Duel Arena is real-time PvP. Win duels to climb the global leaderboard and earn coins.",
    botGoDuel: "Enter the Arena",
    botJobsReply: "Job Portal matches you to roles based on your XP, badges and skill graph. Apply with one tap.",
    botGoJobs: "View Jobs",
    botPlacementsReply: "Live Placements stream new internships and offers in real time — claim them fast.",
    botGoPlacements: "See Live Placements",
    botCertReply: "Every completed course unlocks a verifiable, downloadable certificate (PDF + on-chain hash).",
    botGoCert: "View Certificates",
    botMarketReply: "Spend coins on cosmetics, XP boosts and exclusive content. You currently have your wallet on the dashboard.",
    botGoMarket: "Open Marketplace",
    botAnalyticsReply: "Analytics shows your XP curve, time spent, weak topics and a smart weekly plan.",
    botGoAnalytics: "Open Analytics",
    botAtsReply: "Our ATS Resume builder optimises your CV for keywords and gives an instant readability score.",
    botGoAts: "Build My Resume",
    botTeachReply: "Anyone can become an instructor. Use the AI authoring wizard to publish a course in minutes.",
    botGoTeach: "Teach a Course",
    botAchReply: "Achievements unlock as you level up — rare badges show off your superpowers to recruiters.",
    botGoAch: "View Achievements",
    botSuggestReply: "I can recommend the next course based on your level, streak and goals.",
    botGoSuggest: "See Suggestions",
    botInnovReply: "The Innovation Lab demos 12 next-gen features — emotion-aware AI, VR labs, sign-language avatar and more.",
    botGoInnov: "Open Innovation Lab",
    botXpReply: "You're Lvl 12 with a 15-day streak. Keep daily quests going to multiply your XP gains.",
    botGoDash: "Open Dashboard",
    botTestiReply: "Read what real learners say about Skill Stack — over 4.9★ average across 28k reviews.",
    botGoTesti: "Read Testimonials",
    botHelpReply: "I can explain or jump you to any page: Courses, Quests, Duels, Jobs, Marketplace, Certificates, Analytics, Resume, Teach, Achievements, Suggestions, or Innovation Lab. What do you need?",
  ...
  es: {
    ...
    botName: "Stacky",
    botStatus: "En línea · multilingüe",
    askAssistant: "Pregunta a Stacky",
    openChat: "Abrir asistente", closeChat: "Cerrar",
    chatPlaceholder: "Pregunta lo que quieras sobre Skill Stack…",
    botGreeting: "¡Hola! Soy Stacky, tu guía del portal. Pregúntame sobre cursos, empleos, misiones o cualquier cosa.",
    botFallback: "No te entendí del todo. Prueba a preguntar por cursos, misiones, empleos, mercado, certificados o el Laboratorio de Innovación.",
    qaCourses: "Ver cursos", qaDuel: "Iniciar duelo", qaJobs: "Buscar empleos", qaInnov: "Lab. de Innovación",
  },
  fr: {
    ...
    botName: "Stacky",
    botStatus: "En ligne · multilingue",
    askAssistant: "Demander à Stacky",
    openChat: "Ouvrir l'assistant", closeChat: "Fermer",
    chatPlaceholder: "Pose-moi n'importe quelle question sur Skill Stack…",
    botGreeting: "Salut ! Je suis Stacky, ton guide du portail. Demande-moi à propos des cours, emplois, quêtes, certificats — tout !",
    botFallback: "Je n'ai pas bien saisi. Essaie de demander des cours, quêtes, emplois, marché, certificats ou le Laboratoire d'Innovation.",
    qaCourses: "Voir les cours", qaDuel: "Lancer un duel", qaJobs: "Trouver un emploi", qaInnov: "Lab. d'Innovation",
  },
  de: {
    ...
    botName: "Stacky",
    botStatus: "Online · mehrsprachig",
    askAssistant: "Stacky fragen",
    openChat: "Assistent öffnen", closeChat: "Schließen",
    chatPlaceholder: "Frag mich alles über Skill Stack…",
    botGreeting: "Hi! Ich bin Stacky, dein Portal-Guide. Frag mich nach Kursen, Jobs, Quests, Zertifikaten — alles!",
    botFallback: "Das habe ich nicht ganz verstanden. Frag mich nach Kursen, Quests, Jobs, Marktplatz, Zertifikaten oder dem Innovations-Labor.",
    qaCourses: "Kurse ansehen", qaDuel: "Duell starten", qaJobs: "Jobs finden", qaInnov: "Innovations-Labor",
  },
  hi: {
    ...
    botName: "स्टैकी",
    botStatus: "ऑनलाइन · बहुभाषी",
    askAssistant: "स्टैकी से पूछें",
    openChat: "सहायक खोलें", closeChat: "बंद करें",
    chatPlaceholder: "स्किल स्टैक के बारे में कुछ भी पूछें…",
    botGreeting: "नमस्ते! मैं स्टैकी हूँ, आपका पोर्टल गाइड। कोर्स, नौकरी, क्वेस्ट या किसी भी बारे में पूछें!",
    botFallback: "मुझे ठीक से समझ नहीं आया। कोर्स, क्वेस्ट, नौकरी, बाज़ार, प्रमाणपत्र या इनोवेशन लैब के बारे में पूछें।",
    qaCourses: "कोर्स देखें", qaDuel: "ड्यूल शुरू करें", qaJobs: "नौकरी खोजें", qaInnov: "इनोवेशन लैब",
  },
} as const;
